...
class GraphGameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var box: SKShapeNode!
    var stop : SKNode!
    let backgroundLines = SKSpriteNode(imageNamed: "greenLines")
    ...
    init(size: CGSize, viewController: GraphViewController) {
        ...
        //backgroundLines
        backgroundLines.size = CGSizeMake(size.width, size.height)
        backgroundLines.position = CGPoint(x: size.width/2, y: size.height/2)
        backgroundLines.zPosition = 1
        ...
        timerLabel.position = CGPoint(x: width * 0.625, y: height * 0.8)
        ...
        timer.position = CGPoint(x: width * 0.725, y: height * 0.8)
        ...
        lblScore.position = CGPoint(x: width * 0.675, y: height * 0.9)
        lblScore.text = "0"
        ...
        lblText.position = CGPoint(x: width * 0.45, y: height * 0.9)
    ...
    func createPlayer() -> SKNode {
        ...
        playerNode.position = CGPoint(x: width * 0.01, y: height * 0.43)
    ...
    func createRightArrow() -> SKNode{
        ...
        rightNode.position = CGPoint(x: width * 0.9, y: height * 0.9)
    ...
    func createUpArrow() -> SKNode{
        let upNode = SKNode()
        upNode.position = CGPoint(x: width * 0.85, y: height * 0.95)
    ...
    func createDownArrow() -> SKNode{
        let downNode = SKNode()
        downNode.position = CGPoint(x: width * 0.85, y: height * 0.85)
